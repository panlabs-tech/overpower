...
**A mensagem tem de nomear o par e a saída.** O custo aceito é que duas linhas de 76 vetam um comando sobre as outras 74; o que o torna aceitável é o erro dizer qual runtime, por quê e qual é o conserto — *instalar no repositório em vez da máquina*. Recusa sem conserto nomeado seria trocar um defeito por outro.
